...
func main() {
	...
	//Declare a new servemux and add /v1/healthcheck route which dispatches requests to healthcheckHandler method
	...
	//and uses the servemux we created above as the handler
	srv := &http.Server{
